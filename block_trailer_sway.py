...
def build_model():
    """Splice the generated trailer subtree into the XML before compile.
    All geometry/mass changes MUST happen pre-compile: MuJoCo bakes inertia
    at compile time."""
    ...
    with open(csv_filename, "w", newline="") as f:
        ...
        with mujoco.viewer.launch_passive(model, data) as viewer:
            ...
            while viewer.is_running() and phase_idx < len(schedule):
                ...
                if phase != "settle" and not coasting:
                    data.ctrl[dl] = SPEED_CTRL
                    data.ctrl[dr] = SPEED_CTRL
                steer = {"swerve_r": STEER_FLICK,
                         "swerve_l": -STEER_FLICK}.get(phase, 0.0)
                data.ctrl[sl] = steer
                data.ctrl[sr] = steer
